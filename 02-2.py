...
print("Python's popularity in 1997:", popularity[5][5]) #Python's popularity in 1997: 27
...
print("Python's popularity in 1997:", popularity[idxpython][idx1997]) #Python's popularity in 1997: 27
