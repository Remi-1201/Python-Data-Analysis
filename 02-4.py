"""
2-04/ Example code for printing the contents of a dictionary to the console
"""
...
run_dict_methods() 
"""
dict_keys(['Greiner', 'Rixner', 'Warren'])
dict_values(['Scott', 'John', 'Joe'])
dict_items([('Warren', 'Joe'), ('Greiner', 'John'), ('Rixner', 'Scott')])

['Warren', 'Rixner', 'Greiner']
['Scott', 'Joe', 'John']
[('Greiner', 'John'), ('Rixner', 'Scott'), ('Warren', 'Joe')]
"""
...
"""
Printing dictionary {'Rixner': 'Scott', 'Greiner': 'John', 'Warren': 'Joe'} in readable form
Key = Rixner has value = Scott
Key = Warren has value = Joe
Key = Greiner has value = John

Printing dictionary {'Warren': 'Joe', 'Greiner': 'John', 'Rixner': 'Scott'} in readable form
Key = Rixner has value = Scott
Key = Warren has value = Joe
Key = Greiner has value = John
"""
